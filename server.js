...
const recipeModel = require("./api/recipes.model");
const recipeControllers = require("./api/recipe.controllers");

const app = express();

const dataBaseURL = process.env.DATABASE_URL || "mongodb://localhost:27017";
// const dataBaseURL = "mongodb+srv://daniel:dd2345@recipescluster.anocj.mongodb.net/Rossellinie?retryWrites=true&w=majority";
